...
public:
    ...
    TvecPointF Verts;
    ObjectGeom ObjGeom;
    Float xp, yp, alphap; // Position in the previous time step. (x-xp, y-yp)
                          // gives translation vector
    int ScoreValue;
    ...
    PointF GetXY() { return PointF(fx, fy); }
    ...
    Float GetAlfa() { return falfa; }
    Float GetRotSpeed() { return fomega; }
    void SetRotSpeed(Float omega) { fomega = omega; }
    ...
    void color(Color& in_clr) { clr = in_clr; }
